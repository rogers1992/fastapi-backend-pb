-- Migration 009: Ensure performance indexes exist (idempotent)
-- Safe to run on both Docker PostgreSQL and Neon cloud databases.
-- Run: psql <connection-string> -f db/migrations/009_performance_indexes_neon.sql
...
CREATE INDEX IF NOT EXISTS idx_orders_received_date ON orders(received_date);
